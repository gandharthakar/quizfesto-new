...
import { userLoginFormVS, userLoginValidationSchema } from "@/app/libs/zod/schemas/userAreaValidationSchemas";
...
export default function Page() {
    ...
    const handleFormSubmit: SubmitHandler<userLoginFormVS> = async (formdata) => {
        setIsLoading(true);
