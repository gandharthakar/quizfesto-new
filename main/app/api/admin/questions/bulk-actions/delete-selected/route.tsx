...
export async function DELETE(req: Request) {
    ...
    try {
        ...
        const s1 = sanitize(JSON.stringify(body.question_id_list));
        const question_id_list = JSON.parse(s1);

        // const { token, question_id_list } = body;

        if (token && question_id_list.length > 0) {
