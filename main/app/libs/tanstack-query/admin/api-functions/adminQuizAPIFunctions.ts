...
import { QF_ACreateQuizPayloadType, QF_ADSQuizesPayloadType, QF_AGetQuizDataType, QF_AGetQuizPayloadType, QF_ARAQuizesDataType, QF_AUpdateQuizPayloadType } from "@/app/types/libs/tanstack-query/admin/adminQuizTypes";
...
export const updateSingleQuiz = async (payload: QF_AUpdateQuizPayloadType) => {
